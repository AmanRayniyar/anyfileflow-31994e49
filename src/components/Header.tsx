  ...
  return (
    <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
      <div className="container mx-auto px-4">
        <div className="flex h-14 items-center justify-between gap-3">
          ...
          <div ref={searchRef} className="hidden md:flex relative flex-1 max-w-sm">
            ...
            {showResults && searchResults.length > 0 && (
              <ul id="search-results" role="listbox" className="absolute top-full left-0 right-0 mt-1 bg-card border border-border rounded-lg shadow-lg overflow-hidden z-50 max-h-80 overflow-y-auto">
                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <Link
                      ...
                      className="flex items-center gap-2 px-3 py-2 text-sm hover:bg-secondary/50 first:rounded-t-lg last:rounded-b-lg"
                      role="menuitem"
                    >
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-1 px-2 py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground transition-colors rounded-md hover:bg-secondary/50"
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden pb-4 animate-fade-in" role="dialog" aria-label="Mobile navigation">
            {/* Mobile Search */}
            <div className="mb-3">
              <div className="relative">
                ...
                <input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-9 pr-4 py-2 rounded-lg bg-secondary/50 border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                  aria-label="Search tools"
                />
              </div>
            </div>
            ...
            <nav className="flex flex-col gap-1" aria-label="Mobile navigation">
              ...
              <a
                href="mailto:anyfileflow@gmail.com?subject=Feedback"
                className="px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-secondary rounded-md transition-colors flex items-center gap-2"
              >
