...
const WhyAnyFileFlow = memo(() => {
  return <section className="py-12 bg-gradient-to-b from-primary/5 to-background" aria-labelledby="why-heading">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {features.map(feature => <div key={feature.title} className="bg-card border border-border rounded-xl p-4 text-center hover:border-primary/50 hover:shadow-lg transition-all duration-300">
