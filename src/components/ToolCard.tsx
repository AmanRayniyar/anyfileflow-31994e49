...
const ToolCard = ({ tool }: ToolCardProps) => {
  ...
  return (
    ...
    >
      <div className="bg-card border border-border rounded-xl p-5 h-full hover:border-primary/30 transition-all duration-300">
        <div className="flex items-start gap-4">
          <div className={cn("p-3 rounded-lg", category?.bgClass)}>
