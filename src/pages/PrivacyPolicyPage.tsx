...
const PrivacyPolicyPage = () => {
  return (
    <>
      <SEOHead
        title="Privacy Policy - AnyFile Flow"
        description="Read our privacy policy to understand how AnyFile Flow collects, uses, and protects your personal information."
      />
